...
If the above install fails, you can try installing the package from source. 
Download the newest tar-version from the [source](source/) directory, and install with
